...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，欢迎来到一个菜狗的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ZiXiangCode', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个尝试救赎自己的菜狗', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zixiangcode.github.io', // 网站地址
  ...
  COMMENT_GISCUS_CATEGORY_ID:
      process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOJ7a3Q84CX4fY', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
